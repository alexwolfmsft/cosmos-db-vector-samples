...
import { readFileReturnJson, getClients, insertData, printDiskannSearchResults } from './utils.js';
...
async function main() {
    ...
    try {
        ...
        // Print the results
        printDiskannSearchResults(insertSummary, vectorIndexSummary, searchResults);
